        ...
        <div>
            <div className='mx-auto max-w-7xl mt-16 px-6 mb-20 relative'>
                ...
                <div className='text-center mb-14'>
                    <h3 className='text-offwhite text-3xl md:text-5xl font-bold mb-3'>ABOUT US</h3>
                    <p className='text-bluish md:text-lg font-normal leading-8'>From React to Java, Angular to Node, Vue to Next, and all the way to blockchain, our proficiency covers an expansive spectrum of technologies that drive the modern IT world. Our seasoned team of developers possesses a deep understanding of these frameworks and languages, enabling us to craft tailor-made solutions that align with your unique business needs.</p>
                </div>
