                ...
                <div className='height-work'>
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            ...
                            <p className='text-white md:text-lg font-normal mb-10 md:text-start text-center'>Elevating excellence across all domain: Your partner in comprehensive technical solution</p>
